        ...
        <div className="flex flex-auto justify-center">
          <div className="mx-6 my-3 w-full">
            <Bar
              ...
              percentage="92.80%"
              color="bg-[rgb(16,67,159)]"
            />
            <Bar
              label="Meta LLAM"
              percentage="90.00%"
              color="bg-[rgb(135,76,204)]"
            />
            <Bar
              label="Google Med-Palm 2"
              percentage="88.01%"
              color="bg-[rgb(198,91,207)]"
            />
            <Bar
              label="ChatGPT 4"
              percentage="87.08%"
              color="bg-[rgb(242,123,189)]"
            />
          </div>
        </div>
  ...
  return (
    <div>
      <div className="flex items-center space-x-4">
        <div
          className={` h-6 my-2 flex-grow ${label === "Rejoy Health AI modal" ? "shadow-xl" : "shadow-none"} overflow-hidden relative bg-[rgb(234,244,247)]  rounded-full `}
        >
          <div
            className={`h-6 ${color}  flex items-center rounded-full`}

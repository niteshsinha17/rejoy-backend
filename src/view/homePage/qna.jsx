      ...
      <Section noBottomPadding={true}>
        <Container>
              ...
              <div className=" mt-4">
                ...
                />
                <hr className=" my-4 body-1 h-px "></hr>
                <Question question=" Q. What is the latest standard of care for high cholesterol?"
                          answer="The latest standard of care for high cholesterol, as outlined by the American College of Cardiology and the American Heart Association (ACC/AHA), includes the use of statins as the first-line therapy for lowering low-density lipoprotein cholesterol (LDL-C) according to an individual's atherosclerotic cardiovascular disease (ASCVD) risk and baseline LDL-C levels.skhbfcjv"
                />
                <hr className=" my-4 body-1 h-px "></hr>
